  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 border border-indigo-500/20 text-xs font-semibold transition"
      ...
      {showIosModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[99999] flex items-end sm:items-center justify-center p-4">
          <div className="bg-[#121622] border border-[#1E2638] rounded-3xl w-full max-w-sm p-6 shadow-2xl space-y-4 animate-in slide-in-from-bottom">
            ...
            <div className="space-y-3 bg-[#0B0E14] p-4 rounded-2xl border border-[#1E2638] text-xs">
              <div className="flex items-start gap-3">
                ...
                <span className="text-slate-200">
                  Safari alt çubuğundaki <Share className="w-3.5 h-3.5 inline text-indigo-400 mx-1" /> <strong>Paylaş</strong> butonuna dokunun.
                </span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-slate-200">
                  Aşağı kaydırıp <PlusSquare className="w-3.5 h-3.5 inline text-indigo-400 mx-1" /> <strong>"Ana Ekrana Ekle"</strong> seçeneğini seçin.
                </span>
              </div>
            ...
            <button
              onClick={() => setShowIosModal(false)}
              className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl text-xs transition"
            >
              Tamam, Anladım
            </button>
          </div>
