...
const categoryTranslations: Record<string, { en: string; ru: string }> = {
  'şefin özel menüleri & spesiyaller': { en: "Chef's Specials & Sets", ru: 'Специальные сеты от шефа' },
  'şefin özel menüleri': { en: "Chef's Specials", ru: 'Спецпредложения от шефа' },
  'özel menüler': { en: 'Special Menus', ru: 'Специальное меню' },
  ...
  'ızgaralar & ekmek arası çeşitler': { en: 'Grills & Sandwiches', ru: 'Гриль и сэндвичи' },
  'ızgaralar & ekmek arası': { en: 'Grills & Sandwiches', ru: 'Гриль и сэндвичи' },
  ...
  'burgerler & sandviçler': { en: 'Burgers & Sandwiches', ru: 'Бургеры и сэндвичи' },
  ...
  'pideler & lahmacunlar': { en: 'Turkish Pides & Lahmacun', ru: 'Турецкие пиде и лахмаджун' },
  'pideler': { en: 'Turkish Pides', ru: 'Пиде' },
  'lahmacun': { en: 'Lahmacun', ru: 'Лахмаджун' },
  'tava & fırın yemekleri': { en: 'Pan & Oven Specialties', ru: 'Блюда на сковороде и в печи' },
  'fırın yemekleri': { en: 'Oven Dishes', ru: 'Блюда из печи' },
  'makarnalar & salatalar': { en: 'Pastas & Salads', ru: 'Паста и салаты' },
  'makarnalar': { en: 'Pastas', ru: 'Паста' },
  'salatalar': { en: 'Fresh Salads', ru: 'Салаты' },
  'deniz ürünleri & balıklar': { en: 'Seafood & Fresh Fish', ru: 'Морепродукты и рыба' },
  'deniz ürünleri': { en: 'Seafood', ru: 'Морепродукты' },
  'balıklar': { en: 'Fish', ru: 'Рыба' },
  'mezeler & çorbalar': { en: 'Mezes & Soups', ru: 'Мезе и супы' },
  'taze mezeler & başlangıçlar': { en: 'Fresh Mezes & Starters', ru: 'Свежие мезе и закуски' },
  'mezeler': { en: 'Appetizers & Mezes', ru: 'Мезе и закуски' },
  'çorbalar': { en: 'Hot Soups', ru: 'Супы' },
  'tatlılar & pastalar': { en: 'Desserts & Cakes', ru: 'Десерты и выпечка' },
  'tatlılar': { en: 'Desserts', ru: 'Десерты' },
  'pastalar': { en: 'Cakes', ru: 'Торты и выпечка' },
  'sıcak içecekler & kahveler': { en: 'Hot Drinks & Coffees', ru: 'Горячие напитки и кофе' },
  'sıcak içecekler': { en: 'Hot Drinks', ru: 'Горячие напитки' },
  'kahveler': { en: 'Coffees', ru: 'Кофе' },
  'çaylar': { en: 'Teas', ru: 'Чай' },
  'soğuk içecekler & meyve suları': { en: 'Cold Drinks & Juices', ru: 'Холодные напитки и соки' },
  'soğuk içecekler & meşrubatlar': { en: 'Cold Drinks & Beverages', ru: 'Холодные напитки' },
  'soğuk içecekler': { en: 'Cold Drinks', ru: 'Холодные напитки' },
  'meyve suları': { en: 'Fresh Juices', ru: 'Свежие соки' },
  'alkolsüz kokteyller & mocktailler': { en: 'Mocktails & Virgin Cocktails', ru: 'Безалкогольные коктейли' },
  'alkolsüz kokteyler': { en: 'Mocktails', ru: 'Безалкогольные коктейли' },
  'alkollü içecekler': { en: 'Alcoholic Beverages', ru: 'Алкогольные напитки' },
  'bira & şarap': { en: 'Beers & Wines', ru: 'Пиво и вино' },
  'kokteyller': { en: 'Cocktails', ru: 'Коктейли' },
  'soslar & ekstralar': { en: 'Sauces & Extras', ru: 'Соусы и добавки' },
  'soslar': { en: 'Sauces', ru: 'Соусы' },
  'ekstralar': { en: 'Extras', ru: 'Дополнительно' },
};
...
const descriptionMap: Record<string, { en: string; ru: string }> = {
  ...
  '200 gr zırh kıyması kasap köfte, közlenmiş domates ve biber, sumaklı soğan ve tereyağlı pilav ile': {
  ...
  'Taze somun ekmekte ızgara köfte, domates, marul, sumaklı soğan ve patates kızartması': {
    en: 'Fresh bread sandwich with grilled meatballs, tomatoes, lettuce, sumac onions and fries',
    ru: 'Сэндвич со свежим хлебом, мясными котлетами на гриле, томатами, луком и картофелем фри',
  },
  ...
  'Zırh kıyması, maydanoz, domates, biber ve özel baharatlar ile çıtır ince hamur, yanında yeşillik tabağı ile': {
    en: 'Thin crispy flatbread topped with minced spiced beef, parsley, tomatoes, and fresh herbs salad',
    ru: 'Хрустящий тонкий лахмаджун с рубленым мясом, зеленью, томатами и свежим салатом',
  },
